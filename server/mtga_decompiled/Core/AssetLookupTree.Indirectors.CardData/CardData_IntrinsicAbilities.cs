...
public class CardData_IntrinsicAbilities : IIndirector
{
	...
	public IEnumerable<IBlackboard> Execute(IBlackboard bb)
	{
		...
		foreach (AbilityPrintingData intrinsicAbility in bb.CardData.IntrinsicAbilities)
		{
			bb.Ability = intrinsicAbility;
			yield return bb;
		}
