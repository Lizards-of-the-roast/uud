...
public class CardData_AttachedTo : IIndirector
{
	...
	{
		if (bb.CardData == null || bb.CardData.Instance == null || bb.GameState == null || bb.CardData.Instance.AttachedToId == 0 || !bb.GameState.TryGetEntity(bb.CardData.Instance.AttachedToId, out var mtgEntity))
		{
			yield break;
		}
