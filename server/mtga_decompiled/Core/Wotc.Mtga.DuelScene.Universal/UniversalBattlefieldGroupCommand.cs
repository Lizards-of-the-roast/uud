...
public class UniversalBattlefieldGroupCommand : IUniversalBattlefieldGroup
{
	...
	public UniversalBattlefieldGroupCommand(UniversalBattlefieldGroup.Configuration config, CardHolderManager cardHolderManager)
	{
		Config = config;
	...
	{
		Dimensions = ((_cardHolderManager.GetCardHolder(Config.RegionController, CardHolderType.Command).CardViews.Count > 0) ? Config.Scale : Vector3.zero);
