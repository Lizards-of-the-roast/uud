...
public class NPESelectionWorkflowTranslation : IWorkflowTranslation<SelectNRequest>
{
	...
	public NPESelectionWorkflowTranslation(IContext context, AssetLookupSystem assetLookupSystem, NPEDirector director)
	{
	...
	{
		return new SelectionWorkflow_NPE(req, _cardDatabase, _gameStateProvider, _resolutionEffectProvider, _gameplaySettingsProvider, _cardViewProvider, _cardHolderProvider, _browserManager, _selectionConfirmation, _assetLookupSystem, _director);
	}
}
