...
public class Ability_ModalParentAbilities : IIndirector
{
	...
	public IEnumerable<IBlackboard> Execute(IBlackboard bb)
	{
		...
		foreach (AbilityPrintingData modalAbilityParent in bb.Ability.ModalAbilityParents)
		{
			bb.Ability = modalAbilityParent;
			yield return bb;
		}
