...
public class Ability_ReferencedAbilities : IIndirector
{
	...
	public IEnumerable<IBlackboard> Execute(IBlackboard bb)
	{
		...
		foreach (AbilityPrintingData referencedAbility in bb.Ability.ReferencedAbilities)
		{
			bb.Ability = referencedAbility;
			yield return bb;
		}
