...
public class Interaction_CastingTimeOption_AdditionalCostAbility : IIndirector
{
	...
	public IEnumerable<IBlackboard> Execute(IBlackboard bb)
	{
		...
		{
			if (childRequest is CastingTimeOption_AdditionalCostRequest castingTimeOption_AdditionalCostRequest && bb.AbilityDataProvider.TryGetAbilityPrintingById(castingTimeOption_AdditionalCostRequest.GrpId, out var ability))
			{
				bb.Ability = ability;
				yield return bb;
			}
