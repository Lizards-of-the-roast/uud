...
[Serializable]
[CreateAssetMenu(menuName = "ScriptableObject/Carousel/Event", fileName = "EventCarouselItem")]
public class EventCarouselItem : CarouselItemBase
{
	[Space(20f)]
	...
	{
		EventContext evt = WrapperController.Instance.EventManager.EventContexts.Find((EventContext c) => c.PlayerEvent.EventUXInfo.PublicEventName == EventPublicName);
