...
public class CardData_Printing_TitleId : EvaluatorBase_Int
{
	public override bool Execute(IBlackboard bb)
	{
		...
		goto IL_008b;
		IL_008b:
		return EvaluatorBase_Int.GetResult(MinExpectedResult, MaxExpectedResult, Operation, ExpectedResult, (int)num);
	}
}
