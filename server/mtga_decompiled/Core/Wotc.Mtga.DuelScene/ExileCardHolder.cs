...
public class ExileCardHolder : ZoneCardHolderBase, IExileCardHolder, ICardHolder
{
	...
	public void AddSubCardHolderForPlayer(ICardHolder cardHolder, uint playerId)
	{
		...
		if (cardHolder is PlayerExileCardHolder playerExileCardHolder)
		{
			playerExileCardHolder.SetPlayerId(playerId);
		}
	}
