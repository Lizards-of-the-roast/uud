...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Textbox() {
    return {{
        {.background = {0x12, 0x12, 0x1A, 0xFF},
         .border = {0x55, 0x55, 0x60, 0xFF},
         .text = SDL_Color{0xDD, 0xDD, 0xDD, 0xFF}},
        {.background = {0x18, 0x18, 0x22, 0xFF},
         .border = {0x8B, 0x6F, 0x2E, 0xFF},
         .text = SDL_Color{0xEE, 0xEE, 0xEE, 0xFF}},
        {.background = {0x18, 0x18, 0x22, 0xFF},
         .border = {0xBF, 0x9B, 0x30, 0xFF},
         .text = SDL_Color{0xFF, 0xFF, 0xFF, 0xFF}},
        {.background = {0x18, 0x18, 0x22, 0xFF},
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Label_Title() {
    ...
    for (auto &st : s) {
        ...
        st.text = SDL_Color{0xD4, 0xAF, 0x37, 0xFF};
    }
    return s;
}
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Label_Body() {
    ...
    for (auto &st : s) {
        st.background = {0x00, 0x00, 0x00, 0x00};
        st.border = {0x00, 0x00, 0x00, 0x00};
        st.text = SDL_Color{0xCC, 0xCC, 0xD0, 0xFF};
    }
    return s;
}
