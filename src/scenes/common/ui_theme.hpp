...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Button_Primary() {
    return {{
        {.background = {0x8B, 0x6F, 0x2E, 0xFF},
         .border = {0xBF, 0x9B, 0x30, 0xFF},
         .text = {
             .color = SDL_Color{0xFE, 0xF4, 0xD0, 0xFF},
             .font = state.font[paths::beleren_bold]
         }
        },
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Button_Secondary() {
    return {{
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Button_Danger() {
    return {{
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Textbox() {
    return {{
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Label_Title() {
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Label_Body() {
    std::array<Widget_Style, WIDGET_STYLE_COUNT> s;
    for (auto &st : s) {
        st.background = {0x00, 0x00, 0x00, 0x00};
        st.border = {0x00, 0x00, 0x00, 0x00};
...
inline std::array<Widget_Style, WIDGET_STYLE_COUNT> Panel() {
    std::array<Widget_Style, WIDGET_STYLE_COUNT> s;
    for (auto &st : s) {
