...
struct TTF_Text_Properties {
    ...
    int Set(TTF_Text *text) {
        ...
        if (this->color.has_value() && ++n_opts)
            TTF_SetTextColor(text, this->color.value().r, this->color.value().g,
                             this->color.value().b, this->color.value().a);
        ...
        if (this->string.has_value() && ++n_opts)
            TTF_SetTextString(text, this->string.value().c_str(), this->string.value().length());
    ...
    TTF_Text_Properties &Get(TTF_Text *text) {
        ...
        SDL_Color c;
        TTF_GetTextColor(text, &c.r, &c.g, &c.b, &c.a);
        this->color = c;
