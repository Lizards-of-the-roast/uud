...
public:
    ...
    [[nodiscard]] auto kicker_cost() const -> const std::optional<std::string> & {
        return kicker_cost_;
    }
    void set_kicker_cost(std::string cost) { kicker_cost_ = std::move(cost); }

    [[nodiscard]] auto flashback_cost() const -> const std::optional<std::string> & {
        return flashback_cost_;
    }
    void set_flashback_cost(std::string cost) { flashback_cost_ = std::move(cost); }

    struct AdventureFace {
        std::string name;
        CardType type{CardType::Instant};
        cle::mana::ManaCost mana_cost;
        sol::function effect;
    };
    [[nodiscard]] auto adventure() const -> const std::optional<AdventureFace> & {
        return adventure_;
    }
    void set_adventure(AdventureFace adv) { adventure_ = std::move(adv); }
    ...
    [[nodiscard]] auto back_face() const -> const std::optional<BackFace> & {
        return back_face_;
    }
    void set_back_face(BackFace face) { back_face_ = std::move(face); }
...
private:
    ...
    std::optional<std::string> kicker_cost_;
    std::optional<std::string> flashback_cost_;
    std::optional<AdventureFace> adventure_;
    std::optional<BackFace> back_face_;
};
};  // namespace cle::core
